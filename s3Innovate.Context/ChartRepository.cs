    ...
    public class ChartRepository : IChartRepository
    {
        ...
        public async Task<IEnumerable<SampleChartModel>> GetSampleChart()
        {
            ...
            IList<SampleChartModel> sampleChartList = new List<SampleChartModel>() {
                ...
                new SampleChartModel(){ Time=new DateTime(2012, 8, 13, 07, 00, 00).ToShortTimeString(), Value =500},
                new SampleChartModel(){ Time=new DateTime(2012, 8, 13, 08, 00, 00).ToShortTimeString(), Value =1500}
            };
